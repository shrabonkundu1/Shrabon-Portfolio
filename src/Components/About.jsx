...
const About = () => {
    ...
    return (
        <div className='bg-[#190b1f] mb-20 md:mb-28 ' id='about' >
            <h2 className='text-4xl text-center md:mt-10 font-medium text-gray-200 font-ysabeau md:text-6xl font-grotesk mb-10 '  data-aos="fade-up">About Me</h2>
            ...
            <div data-aos="fade-left">
                ...
                <p className='text-gray-50  text-[18px]' data-aos="fade-right">
