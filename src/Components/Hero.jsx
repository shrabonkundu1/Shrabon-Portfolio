...
const Hero = () => {
  return (
    <div className="pt-24  mx-auto relative">
        <div className="grid md:grid-cols-2 place-items-center gap-8">
            ...
            >
                ...
                <TypeAnimation
                    ...
                    speed={50}
                    repeat={Infinity}
                    className="font-bold text-gray-400 text-xl md:text-5xl italic mt-3 py-16"
                />
                ...
                >
                   I am a web developer from Bangladesh, creating visually stunning and user-friendly experiences.
                </motion.p>
